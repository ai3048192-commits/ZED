                ...
                >
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      <div 
                        style={{
                          backgroundColor: '#2563eb', // لون خلفية أزرق صريح
                          borderColor: '#1d4ed8'
                        }}
                        className="w-12 h-12 rounded-xl border p-3 flex items-center justify-center shadow-md text-white"
                      >
                        {steps[activeIndex].image ? (
                          ...
                          <Compass className="w-full h-full text-white drop-shadow-md" />
                        )}
                      </div>
                      <span 
                        style={{
