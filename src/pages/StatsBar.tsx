      ...
      <div className="max-w-7xl mx-auto px-6 relative z-10">
        ...
        <div className="text-center max-w-2xl mx-auto mb-14">
          <motion.div 
            ...
            className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full border text-xs font-bold mb-4 shadow-sm"
          >
          ...
          >
            أرقام تعكس <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600">ثقتكم</span> وتميزنا
          </motion.h2>
          ...
          <motion.p 
            ...
            className="text-sm md:text-base mt-4 leading-relaxed font-bold"
          >
        ...
        <div 
          style={{
            ...
            boxShadow: isDark ? '0 25px 50px -12px rgba(0, 0, 0, 0.25)' : '0 10px 25px -5px rgba(0, 0, 0, 0.1)'
          }}
          className="relative border-2 rounded-[2.5rem] p-4 transition-colors duration-300"
        >
            ...
            {stats.map((stat, idx) => {
              ...
              return (
                <motion.div
                  ...
                  style={{
                    backgroundColor: isDark ? 'rgba(2, 6, 23, 0.4)' : '#f8fafc',
                    borderColor: isDark ? 'rgba(30, 41, 59, 0.5)' : '#e2e8f0'
                  }}
                  className="group relative border-2 rounded-3xl p-6 transition-all duration-300 flex flex-col justify-between overflow-hidden shadow-sm"
                >
                  ...
                  <div>
                    <div className="flex items-center justify-between mb-6">
                      {/* أيقونة بلون أزرق ثابت وواضح */}
                      <div className="w-12 h-12 rounded-2xl bg-blue-600 text-white flex items-center justify-center group-hover:scale-110 group-hover:bg-blue-700 transition-all duration-300 shadow-md">
                        {stat.icon_url ? (
                          <img 
                            src={stat.icon_url} 
                            alt={stat.label} 
                      ...
                      <div 
                        ...
                        className="w-8 h-8 rounded-full flex items-center justify-center group-hover:text-blue-600 group-hover:bg-blue-500/10 transition-colors"
                      >
                    ...
                    <div>
                      <div 
                        ...
                        className="text-3xl lg:text-4xl font-black tracking-tight group-hover:text-blue-600 transition-colors"
                      >
                        {stat.value}
                      </div>
                      <div 
                  ...
                  <div 
                    style={{ borderColor: isDark ? 'rgba(30, 41, 59, 0.5)' : '#cbd5e1' }}
                    className="mt-6 pt-3 border-t"
                  >
                    <p 
                      style={{ color: isDark ? '#94a3b8' : '#334155' }}
                      className="text-xs font-bold leading-relaxed line-clamp-1"
                    >
                      {stat.description}
                    </p>
                  </div>
